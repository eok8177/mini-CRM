...
class UserController extends Controller
{
	...
	/**
	 * @Route("/users", name="sadmin_users_list")
	 */
	public function listAction(Request $request)
	{
		...
		return $this->render('sadmin/users/list.html.twig', [
			'users' => $users,
	...
	/**
	 * @Route("/filter/{id}", name="admin_user_filter", defaults={"id" = 0})
	 */
	public function filterAction($id, Request $request)
	{
		...
		if (!$club) {throw $this->createNotFoundException('No club found');}
	...
	/**
	 * @Route("/user/edit/{id}", name="sadmin_user_edit", defaults={"id" = 0})
	 */
	public function editAction($id, Request $request)
	{
		...
		if ($form->isSubmitted() && $form->isValid()) {
			...
			return $this->redirectToRoute('sadmin_user_edit', [
				'id' => $user->getId(),
				]);
		}

		return $this->render('sadmin/users/edit.html.twig', [
	...
	/**
	 * @Route("/user/delete/{id}", name="sadmin_user_delete")
	 */
	public function deleteAction($id, Request $request)
	{
		if ($this->getUser()->getId() == $id) {
			...
			return $this->redirectToRoute('sadmin_users_list');
		}
	...
	/**
	 * @Route("/avatar/delete/{id}", name="sadmin_user_delete_avatar")
	 */
